...
pub struct FullLevel {
    ...
    pub add_nat_def: i64,
    pub add_arm_def: i64,
    pub add_bonus_dmg: i64,
    pub add_speed: i64,
    pub trad_choices: i64,
    pub lang_choices: i64,
    pub novice_spells: i64,
    pub expert_spells: i64,
    pub master_spells: i64,
    pub size: Option<etc::Size>,
    pub languages: Vec<String>,
    pub path_talents: Vec<FullPathTalent>,
    pub speed_traits: Vec<FullSpeedTrait>,
    pub traditions: Vec<LevelTradition>,
}
